...
public class KubernetesServiceImpl implements KubernetesService {
    ...
    @Override
    public String retrieveSecret(String namespace, String secretName, String secretKey) throws SecretNotFoundException {
                            ...
                            entry -> {
                                ...
                                if (entry.getKey().equalsIgnoreCase("valueFrom")) {
                                    ...
                                    if (secretRef.size() == 1 && secretRef.containsKey("secretKeyRef")) {
                                        ...
                                        try {
                                            entry.setValue(
                                                    retrieveSecret(secretNamespace.orElse(namespace), secretName, secretKey)
                                            );
