...
public class ServicesValidator implements ResourceValidator {
    private final GraviteeServices oldServices;
    private final GraviteeServices services;

    @Autowired
    protected GraviteeServicesService servicesService;

    public ServicesValidator(KubernetesResource oldServices, KubernetesResource services) {
        this.oldServices = (GraviteeServices) oldServices;
        this.services = (GraviteeServices) services;
    }
