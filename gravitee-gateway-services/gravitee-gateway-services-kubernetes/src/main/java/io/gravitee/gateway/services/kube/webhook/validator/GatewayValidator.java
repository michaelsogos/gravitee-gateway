...
public class GatewayValidator implements ResourceValidator {
    private final GraviteeGateway oldGateway;
    private final GraviteeGateway gateway;
    ...
    public GatewayValidator(KubernetesResource oldGateway, KubernetesResource gateway) {
        this.oldGateway = (GraviteeGateway) oldGateway;
        this.gateway = (GraviteeGateway) gateway;
    }
