...
public class AdmissionReviewTest {
    ...
    public void readAdmissionReview_Gateway() throws Exception {
        ...
        KubernetesDeserializer.registerCustomKind("gravitee.io/v1beta1", "GraviteeGateway", GraviteeGateway.class);
        assertNotNull(mapper.readValue(this.getClass().getResourceAsStream("/admission-review/gateway-update.json"), AdmissionReview.class));
    }

    @Test
    public void readAdmissionReview_Plugin() throws Exception {
        ObjectMapper mapper = Serialization.jsonMapper();
        KubernetesDeserializer.registerCustomKind("gravitee.io/v1beta1", "GraviteePlugins", GraviteePlugin.class);
        assertNotNull(mapper.readValue(this.getClass().getResourceAsStream("/admission-review/plugins-create.json"), AdmissionReview.class));
    }
}
